...
export const KIDS_TOPICS: Record<number, TopicKidsInfo> = {
  1: {
    id: 1, color: 'olive', hex: '#7C8E3E',
    icon: '🌍',
    name_ar: 'عجائب الكون',
    name_en: 'Wonders of the Universe',
    bgGradient: 'linear-gradient(135deg, #F0F3E3 0%, #E4EAD0 100%)',
  },
  2: {
    id: 2, color: 'sky', hex: '#5BA3CF',
    icon: '🌳',
    name_ar: 'الجنة والمؤمنون',
    name_en: 'Paradise & Believers',
    bgGradient: 'linear-gradient(135deg, #E8F2FA 0%, #D4E8F5 100%)',
  },
  3: {
    id: 3, color: 'gold', hex: '#C9A43E',
    icon: '📜',
    name_ar: 'أحكام الإسلام',
    name_en: 'Rules of Islam',
    bgGradient: 'linear-gradient(135deg, #F9F3E1 0%, #F0E6C8 100%)',
  },
  4: {
    id: 4, color: 'pink', hex: '#D4839B',
    icon: '⛺',
    name_ar: 'قصص الأنبياء',
    name_en: 'Stories of Prophets',
    bgGradient: 'linear-gradient(135deg, #FAEEF2 0%, #F2D9E2 100%)',
  },
  5: {
    id: 5, color: 'purple', hex: '#9B8EC4',
    icon: '📖',
    name_ar: 'القرآن العظيم',
    name_en: 'The Great Quran',
    bgGradient: 'linear-gradient(135deg, #F0EDF7 0%, #E2DBF0 100%)',
  },
  6: {
    id: 6, color: 'turquoise', hex: '#4DBDB5',
    icon: '⚖️',
    name_ar: 'يوم القيامة',
    name_en: 'Day of Judgment',
    bgGradient: 'linear-gradient(135deg, #E5F6F5 0%, #D0EDEA 100%)',
  },
  7: {
    id: 7, color: 'orange', hex: '#D4854A',
    icon: '🛡️',
    name_ar: 'التحذير والتوبة',
    name_en: 'Warning & Repentance',
    bgGradient: 'linear-gradient(135deg, #FAF0E8 0%, #F2DFD0 100%)',
  },
};
